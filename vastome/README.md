# Vastome — Build smart. Scale further.

Vastome is a production-ready multi-page marketing website for an enterprise IT company. The site is built with vanilla HTML, CSS, and JavaScript — no build step, no frameworks. It implements the full Vastome Brand & Design System v2.0.
...
├── brand-guide.html        Vastome Brand Guide v2.0
...
Then visit: [http://localhost:8000/Vastome/](http://localhost:8000/Vastome/)
...
Then visit: [http://localhost:3000/Vastome/](http://localhost:3000/Vastome/)

---

## Live URL

**[https://shashankbagda.github.io/Vastome/](https://shashankbagda.github.io/Vastome/)**
...
© 2026 Vastome. All rights reserved.
